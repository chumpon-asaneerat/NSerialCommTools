namespace NLib.Dde.Foundation.Server
{
    ...
    internal abstract class DdemlServer : IDisposable
    {
        ...
        public virtual void Register()
        {
            ...
            if (IsRegistered)
            {
                throw new InvalidOperationException(DDE.AlreadyRegisteredMessage);
            }
            ...
            if (_ServiceHandle == IntPtr.Zero)
            {
                ...
                string message = DDE.RegisterFailedMessage;
        ...
        public virtual void Advise(string topic, string item)
        {
            ...
            {
                int error = Ddeml.DdeGetLastError(_InstanceId);
                string message = DDE.AdviseFailedMessage;
                message = message.Replace("${service}", _Service);
        ...
        public virtual void Resume(DdemlConversation conversation)
        {
            ...
            {
                int error = Ddeml.DdeGetLastError(_InstanceId);
                throw new DdemlException(DDE.ServerResumeFailedMessage, error);
            }
        ...
        public virtual void Resume()
        {
            ...
            {
                int error = Ddeml.DdeGetLastError(_InstanceId);
                throw new DdemlException(DDE.ServerResumeAllFailedMessage, error);
            }
