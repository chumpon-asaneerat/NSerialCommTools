...
namespace NLib.Dde.Foundation.Advanced
{
    ...
    internal sealed class DdemlContext : IDisposable
    {
        ...
        public void Initialize()
        {
            ...
            if (IsInitialized)
            {
                throw new InvalidOperationException(DDE.AlreadyInitializedMessage);
            }
        ...
        public void AddTransactionFilter(IDdemlTransactionFilter filter)
        {
            ...
            {
                throw new InvalidOperationException(DDE.FilterAlreadyAddedMessage);
            }
        ...
        public void RemoveTransactionFilter(IDdemlTransactionFilter filter)
        {
            ...
            if (!_Filters.Contains(filter))
            {
                throw new InvalidOperationException(DDE.FilterNotAddedMessage);
            }
        ...
        internal void Initialize(int afCmd)
        {
            ...
            if (_InstanceId == 0)
            {
                ...
                throw new DdemlException(DDE.InitializeFailedMessage, error);
            }
        }
