...
namespace NLib.Components
{
    ...
    partial class NDbConnection
    {
        ...
        private void Tick(object state)
        {
            ...
            if (ts.TotalSeconds >= this.Config.Optional.AutoDetectInterval)
            {
                ...
                if (this._onExecuting)
                {
                    ...
                    {
                        "Detected some executing method. assume this should be OK.".Info();
                    }
                ...
                if (IsConnectionInUsed())
                {
                    ...
                    if (this.EnableDetailDebug)
                    {
                        "Detected some Reader seem to be still in used. assume this should be OK.".Info();
                    }
        ...
        private void ConnectToDatabase()
        {
            ...
            if (_connecting)
            {
                "Ignore because call connect when application still in connecting process.".Info();
            ...
            else
            {
                lock (this)
                {
                    ...
                    if (!ConnectionPools.Instance.IsExists(uniqueName))
                    {
                        ...
                        if (null == conn)
                        {
                            "ConnectToDatabase : Cannot create connection instance.".Info();
                            DoConnectFailed(); // Raise event
                            return;
                        }
                    ...
                    if (null == connRef)
                    {
                        "ConnectToDatabase : Cannot get connection reference.".Info();
                        DoConnectFailed(); // Raise event
                        return;
                    }
    ...
    partial class NDbConnection
    {
        ...
        private void ClearRecordsets()
        {
            if (null != _recordsets)
            {
                ...
                if (null != rsRefs)
                {
                    if (this.EnableDetailDebug)
                    {
                        "Begin release all recordsets.".Info();
                    ...
                    foreach (RecordsetReference rsRef in rsRefs)
                    {
                        ...
                        if (this.EnableDetailDebug)
                        {
                            "Free Recordset Reference (Call by ClearRecordsets)".Info();
                        }
                        rsRef.Free(); // Free the recordset
                    }
                    if (this.EnableDetailDebug)
                    {
                        "Finished release all recordsets.".Info();
                    }
                }
                lock (this)
                {
        ...
        private bool IsRecordsetsStillAlive()
        {
            ...
            foreach (RecordsetReference rsRef in allRS)
            {
                if (null != rsRef && !rsRef.IsAlive())
                {
                    if (this.EnableDetailDebug)
                    {
                        "Remove and Free Recordset Reference".Info();
                    }
                ...
                else
                {
                    ...
                    finally
                    {
                        ...
                        if (null != command)
                        {
                            ...
                            {
                                "Dispose command detected exception.".Err(ex);
                            }
                            finally
                            {
                                // Free Memory
            ...
            DbTransaction transaction = null)
        {
                ...
                command.Connection.State == ConnectionState.Open)
            {
                    ...
                    command.Transaction != transaction)
                {
                    ...
                    {
                        "Detected exception in assigned transaction.".Err(ex);
                ...
                if (null != adaptor)
                {
                    ...
                    finally
                    {
                        ...
                        if (null != adaptor)
                        {
                            ...
                            {
                                "Dispose adaptor detected exception.".Err(ex);
                            }
                        }
                        adaptor = null;
                    ...
                    if (null != reader)
                    {
                        ...
                        try
                        {
                            do
                            {
                                ...
                                {
                                    "Detected exception in Fill operation.".Err(ex0);
                        ...
                        {
                            "Detected exception in Read Next operation.".Err(err);
                        }
                        ...
                        {
                            "Detected exception in Close Reader operation.".Err(ex1);
                        }
                        ...
                        {
                            "Detected exception in Dispose Reader operation.".Err(ex2);
                        }
            ...
            DbTransaction transaction = null)
        {
                ...
                command.Connection.State == ConnectionState.Open)
            {
                ...
                {
                    "Detected exception in Derived Parameters operation.".Err(ex);
                }
                ...
                {
                    "Detected exception in Assign Parameters operation.".Err(ex);
                }
                ...
                try
                {
                    ...
                    if (null != reader)
                    {
                        ...
                        if (null != _recordsets)
                        {
                            ...
                            if (this.EnableDetailDebug)
                            {
                                "Recordset Reference is registered.".Info();
                            }
                        }
                        else
                        {
                            if (this.EnableDetailDebug)
                            {
                                "Cannot add recordset reference into null list.".Info();
                            }
                        }
                    }
                    ShowNormalCursor();
        ...
        public DateTime GetSystemDateTime(DbTransaction transaction = null)
        {
                ...
                this.DbConnection.State == ConnectionState.Open)
            {
                ...
                {
                    "Detected exception in GetSystemDate operation.".Err(ex);
                    dt = DateTime.Now;
                }
                finally
                {
    ...
    partial class NDbConnection
    {
        ...
        public DataTable GetSchema(DbMetaData value, DbRestriction[] restrictions)
        {
            ...
            if (null != this.Factory)
            {
                ...
                {
                    "Detected exception in GetSchema operation.".Err(ex);
                    results = null;
                }
                finally
                {
        ...
        public DataTable GetSchemaTable(DbCommand command, DbTransaction transaction)
        {
                ...
                null != this.Factory)
            {
                ...
                {
                    "Detected exception in GetSchemaTable operation.".Err(ex);
                    results = null;
                }
                finally
                {
