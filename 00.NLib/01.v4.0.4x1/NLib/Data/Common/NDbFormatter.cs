...
namespace NLib.Data
{
    ...
    public class NDbFormatter
    {
        ...
        private void InitDefaultDelegates()
        {
            ...
            this.RequiredSPParameterPrefix = () =>
            {
                return true;
            };
        ...
        /// <summary>
        /// Gets or sets delegate method for check need prefix for stored procedure's parameter.
        /// The delegate should returns true or false. Default is true.
        /// </summary>
        [Category("Stored Procedures")]
        [Description("Gets or sets delegate method for check need prefix for stored procedure's parameter.")]
        public Func<bool> RequiredSPParameterPrefix { get; set; }
