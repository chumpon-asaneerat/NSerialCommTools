...
namespace NLib.Data
{
    ...
    public class Recordset : IDisposable
    {
        ...
        private void Free()
        {
            ...
            {
                "Free : detected exception in Close Reader operation.".Info();
                ex1.Err();
            }
            ...
            {
                "Free : detected exception in Dispose Reader operation.".Info();
                ex2.Err();
            }
            _reader = null;
            ...
            if (null != _command)
            {
                ...
                {
                    "Free : (dispose command) detected exception.".Info();
                    ex.Err();
                }
                finally
                {
        ...
        private void ProcessRecord()
        {
            try
            {
                ...
                {
                    "ProcessRecord : detected exception in Fill operation.".Info();
                    ex.Err();
            ...
            {
                "ProcessRecord : detected exception in initialize row.".Info();
                ex.Err();
                Free(); // whenever error occur Free it.
            }
        }
            ...
            if (null != _reader && _canMakTable)
            {
                ...
                try
                {
                    do
                    {
                        ...
                        {
                            "Fill From Reader : detected exception in Fill operation.".Info();
                            ex0.Err();
                            if (null != table)
                            {
                                try { table.Dispose(); }
                ...
                {
                    "Fill From Reader : detected exception in Read Next operation.".Info();
                    err.Err();
                    results = null;
                }
                Free();
    ...
    public sealed class TransactionScope : IDisposable
    {
        ...
        public void Commit()
        {
            ...
            {
                "Detected Error in Commit operation.".Err(ex);
            }
            _transaction = null;
            _needRollback = false;
            _operationCount = 0;
        ...
        public void Rollback()
        {
            ...
            {
                "Detected Error in Rollback operation.".Err(ex);
            }
            _transaction = null;
            _needRollback = false;
            _operationCount = 0;
