...
namespace NLib.Data
{
    ...
    public abstract class NDbFactory
    {
        ...
        /// <summary>
        /// Checks is required parameter prefix.
        /// </summary>
        /// <returns>Returns true if required.</returns>
        protected bool RequiredSPParameterPrefix()
        {
            if (null != _formatter)
                return _formatter.RequiredSPParameterPrefix();
            return false;
        }
        /// <summary>
        ...
        where TBuilder : DbCommandBuilder
    {
            ...
            string[] parameterNames, object[] parameterValues)
        {
            ...
            if (this.RequiredSPParameterPrefix())
            {
                parameterPrefix = GetParameterPrefix(); // read prameter prefix
            }
            int len = parameterNames.Length;
            for (int i = 0; i < len; i++)
            {
                string paraName = parameterPrefix + parameterNames[i].Trim();
            ...
            DbMetaData value)
        {
            ...
            try
            {
                ...
                {
                    "No restriction data return.".Info();
                }
        ...
        protected List<DbTable> _GetDbTables(TConnection connection, string owner)
        {
            ...
            try
            {
                    ...
                    null != info.Convert)
                {
                    ...
                    {
                        "The table schema no data return.".Info();
                    }
                ...
                {
                    "The table schema info is null.".Info();
                }
                    ...
                    null != info.Convert)
                {
                    ...
                    {
                        "The view schema no data return.".Info();
                    }
                }
                else
                {
                    "The view schema info is null.".Info();
                }
            ...
            string owner, string procedureName)
        {
            ...
            try
            {
                ...
                if (this.DerivedParameters(command))
                {
                    ...
                    {
                        "Fill adaptor detected exception.".Err(ex);
                    }
                    finally
                    {
                        #region Free
            ...
            {
                "Get Procedure Info Error.".Err(ex);
                return null;
            }
