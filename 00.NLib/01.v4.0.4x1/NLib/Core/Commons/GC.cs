    ...
    public static class NGC
    {
        ...
        public static void FreeGC(object value)
        {
            ...
            try
            {
                ...
                if (value != null)
                {
                    ...
                    catch (Exception exx)
                    {
                        ...
                        "FreeGC Detected Exception when SuppressFinalize an object instance".Err();
                        exx.Err();
                ...
                if (needToRelease)
                {
                    ...
                    if (ts.TotalMilliseconds > _releaseInMillisecond)
                    {
                        ...
                        {
                            "Force GC to Free Unused Memory.".Info();                            
                        }
            ...
            catch (Exception ex)
            {
                ...
                "FreeGC Detected Exception when Collect memory and WaitForPendingFinalizers.".Err();
                ex.Err();
