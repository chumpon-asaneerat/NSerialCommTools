...
Update 2009-12-24
=================
- Rewrite code for Reflection Type System
  - TypeEx class is rewrite in C# 2.0 language spec.
  - TypeEx class is rewrite now fully supports Generic.
  - TypeEx class is rewrite now has internal attribute cache management.
...
namespace NLib.Reflection
{
	...
	/// <summary>
	/// TypeEx Class. A wrapper around the <see cref="Type"/> class.
	/// </summary>
	...
	public class TypeEx
	{
		...
		/// <summary>
		/// Constructor. Initializes a new instance of the <see cref="TypeEx"/> class.
		/// </summary>
		...
		private static readonly Dictionary<Type, object[]> _typeAttributesTopInternal = new Dictionary<Type, object[]>(10);
		private static readonly Dictionary<Type, object[]> _typeAttributesInternal = new Dictionary<Type, object[]>(10);
		private static readonly Dictionary<string, object[]> _typeAttributes = new Dictionary<string, object[]>(10);
		...
		private static void GetAttributesInternal(List<object> list, Type type)
		{
			object[] attrs;
		...
		private static void GetAttributesTreeInternal(List<object> list, Type type)
		{
			object[] attrs;
			...
			/*
			bool filterOutBaseEqualAttributes =
				Common.Configuration.FilterOutBaseEqualAttributes;
			*/
			bool filterOutBaseEqualAttributes = false;
			if (filterOutBaseEqualAttributes)
			{
		...
		{
			object[] attrs = new TypeEx(type).GetAttributes(attributeType);
		...
		{
			object[] attrs = new TypeEx(type).GetAttributes(typeof(T));
		...
		{
			return _type.GetMethod(methodName, flags,
				generic ? GenericBinder.Generic : GenericBinder.NonGeneric, types, null);
		}
		...
		*/
		...
		/// <summary>
		/// Converts the supplied <see cref="Type"/> to a <see cref="TypeEx"/>.
		/// </summary>
		...
		public static implicit operator TypeEx(Type type)
		{
			...
			return new TypeEx(type);
		}
		/// <summary>
		/// Converts the supplied <see cref="TypeEx"/> instance to a <see cref="Type"/>.
		/// </summary>
		/// <param name="typeEx">The TypeEx instance.</param>
		/// <returns>A Type.</returns>
		public static implicit operator Type(TypeEx typeEx)
		{
			if (typeEx == null)
				throw new ArgumentNullException("typeEx");
		...
		public static bool IsSameOrParent(/*[JetBrains.Annotations.NotNull] */
			Type parent, /*[JetBrains.Annotations.NotNull] */Type child)
		{
			if (parent == null)
		...
		public static Type GetGenericType(/*[JetBrains.Annotations.NotNull] */
			Type genericType,
			Type type)
		{
			if (genericType == null)
		...
		/// <returns>A <see cref="MethodInfo"/> object representing the method
		/// that matches the specified requirements, if found; otherwise, null.</returns>
		public static MethodInfo GetMethod(/*[JetBrains.Annotations.NotNull] */
			Type type, bool generic, string methodName, BindingFlags flags)
		{
			if (type == null)
				throw new ArgumentNullException("type");
		...
		public static MethodInfo GetMethod(Type type, string methodName,
			BindingFlags bindingFlags, int requiredParametersCount,
