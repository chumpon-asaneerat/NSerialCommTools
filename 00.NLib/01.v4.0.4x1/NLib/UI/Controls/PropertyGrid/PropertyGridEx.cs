            ...
            get
            {
                ...
                if (oRow.RowState != DataRowState.Deleted)
                {
                    ...
                    else
                    {
                        ...
                        {
                            "Bind of DataRow with a DataSource that is not a DataTable is not possible".Err();
                            return null;
                        }
                    }
                }
            ...
            set
            {
                ...
                if (oRow.RowState != DataRowState.Deleted)
                {
                    ...
                    else
                    {
                        ...
                        {
                            "Bind of DataRow with a DataSource that is not a DataTable is impossible".Err();
                        }
                    }
                }
            }
