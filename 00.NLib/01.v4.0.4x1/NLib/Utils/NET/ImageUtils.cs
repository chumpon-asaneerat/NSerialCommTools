...
namespace NLib.Utils
{
    ...
    public class ImageUtils
    {
        ...
        public static byte[] GetImage(string fileName)
        {
            ...
            {
                "File Name : {0} not found.".Info(fileName);
            }
            else
            {
                "File Name : {0} found.".Info(fileName);
            }
            ...
            catch (Exception ex)
            {
                ...
                throw ex;
#else
                "Detected error during access FileStream.Length or Set FileStream Position.".Err();
                ex.Err();
#endif
            }
            ...
            catch (Exception ex)
            {
                ...
                throw ex;
#else
                "Detected error during create bynary reader.".Err();
                ex.Err();
#endif
            }
            ...
            if (isReaderCreated && null != reader)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw ex;
#else
                    "Detected error during read data from bynary reader.".Err();
                    ex.Err();
#endif
                }
            }
        ...
        public static byte[] GetImage(System.Drawing.Image img)
        {
            ...
            {
                results = null;
                "Detected error during build BitmapSource from MemoryStream.".Err();
                ex.Err();
            }
            finally
            {
        ...
        public static BitmapSource GetBitmapSource(byte[] buffers)
        {
            ...
            {
                // buffer is null.
                "Parameter 'buffers' is null or empty.".Err();
                return img;
            }
        ...
        public static BitmapSource GetBitmapSource(Uri uri)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw ex;
#else
                "Detected error during load bitmap source from Uri.".Err();
                object dump = new object();
                dump.Dump(new { uri.AbsoluteUri });
                dump.Dump(new { uri.AbsolutePath });
                dump.Dump(new { uri.Authority });
                ex.Err();
                return img;
#endif
            }
        ...
        public static BitmapSource GrayScale(BitmapSource image)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw ex;
#else
                "Detected error during convert bitmap source to gray scale.".Err();
                ex.Err();
#endif
            }
