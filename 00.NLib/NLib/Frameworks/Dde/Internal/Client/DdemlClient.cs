namespace NLib.Dde.Foundation.Client
{
    ...
    using NLib.Dde;
    using DDE = NLib.Resource.Dde.DDE;
    ...
    internal class DdemlClient : IDisposable
    {
        ...
        public DdemlClient(string service, string topic, DdemlContext context)
        {
            ...
            {
                throw new ArgumentException(DDE.StringParameterInvalidMessage, "service");
            }
            if (topic == null)
            {
            ...
            {
                throw new ArgumentException(DDE.StringParameterInvalidMessage, "topic");
            }
            if (context == null)
            {
            ...
            if (!_Disposed)
            {
                ...
                if (disposing)
                {
                    if (IsConnected) 
                    {
                        ...
                        {
                            arb.Process(new DdemlException(DDE.NotConnectedMessage));
                        }
        ...
        public virtual void Connect()
        {
            ...
            if (error == -2)
            {
                throw new InvalidOperationException(DDE.AlreadyConnectedMessage);
            }
            if (error > Ddeml.DMLERR_NO_ERROR)
            {
                string message = DDE.ConnectFailedMessage;
        ...
        public virtual void Disconnect()
        {
            ...
            if (!IsConnected)
            {
                throw new InvalidOperationException(DDE.NotConnectedMessage);
            }
        ...
        public virtual void Pause()
        {
            ...
            if (!result)
            {
                ...
                throw new DdemlException(DDE.ClientPauseFailedMessage, error);
            }
        ...
        public virtual void Resume()
        {
            ...
            if (!IsPaused)
            {
                throw new InvalidOperationException(DDE.NotPausedMessage);
            }
            ...
            {
                int error = Ddeml.DdeGetLastError(_InstanceId);
                throw new DdemlException(DDE.ClientResumeFailedMessage, error);
            }
        ...
        public virtual void Abandon(IAsyncResult asyncResult)
        {
            ...
            {
                throw new ArgumentException(DDE.AsyncResultParameterInvalidMessage, "asyncResult");
            }
        ...
        public virtual void Execute(string command, int timeout)
        {
            ...
            {
                throw new ArgumentException(DDE.StringParameterInvalidMessage, "command");
            }
            if (error == -3 && timeout <= 0)
            {
                throw new ArgumentException(DDE.TimeoutParameterInvalidMessage, "timeout");
            }
            if (error > Ddeml.DMLERR_NO_ERROR)
            {
                string message = DDE.ExecuteFailedMessage;
        ...
        public virtual void EndExecute(IAsyncResult asyncResult)
        {
            ...
            {
                string message = DDE.AsyncResultParameterInvalidMessage;
        ...
        public virtual void Poke(string item, byte[] data, int format, int timeout)
        {
            ...
            {
                throw new ArgumentException(DDE.StringParameterInvalidMessage, "item");
            }
            if (error == -3 && timeout <= 0)
            {
                throw new ArgumentException(DDE.TimeoutParameterInvalidMessage, "timeout");
            ...
            if (error > Ddeml.DMLERR_NO_ERROR)
            {
                string message = DDE.PokeFailedMessage;
                message = message.Replace("${service}", _Service);
                message = message.Replace("${topic}", _Topic);
        ...
        public virtual void StartAdvise(string item, int format, bool hot, bool acknowledge, int timeout, object adviseState)
        {
            ...
            {
                string message = DDE.AlreadyBeingAdvisedMessage;
                message = message.Replace("${service}", _Service);
                message = message.Replace("${topic}", _Topic);
                message = message.Replace("${item}", item);
            ...
            if (result == IntPtr.Zero)
            {
                ...
                int error = Ddeml.DdeGetLastError(_InstanceId);
                string message = DDE.StartAdviseFailedMessage;
                message = message.Replace("${service}", _Service);
                message = message.Replace("${topic}", _Topic);
                message = message.Replace("${item}", item);
                throw new DdemlException(message, error);
        ...
        public virtual void StopAdvise(string item, int timeout)
        {
            ...
            if (!_AdviseLoopTable.ContainsKey(item))
            {
                string message = DDE.NotBeingAdvisedMessage;
                message = message.Replace("${service}", _Service);
                message = message.Replace("${topic}", _Topic);
                message = message.Replace("${item}", item);
                throw new InvalidOperationException(message);
            ...
            {
                int error = Ddeml.DdeGetLastError(_InstanceId);
                string message = DDE.StopAdviseFailedMessage;
                message = message.Replace("${service}", _Service);
                message = message.Replace("${topic}", _Topic);
                message = message.Replace("${item}", item);
                throw new DdemlException(message, error);
