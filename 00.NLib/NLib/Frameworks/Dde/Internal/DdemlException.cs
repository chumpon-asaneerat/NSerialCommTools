...
namespace NLib.Dde.Foundation
{
    ...
    internal class DdemlException : Exception
    {
        ...
        public DdemlException() : this(DDE.UnknownErrorMessage)
        {
        }
        ...
        {
            _Code = info.GetInt32("NLib.Dde.Ddeml.DdemlException.Code");
        }
        ...
        {
            info.AddValue("NLib.Dde.Ddeml.DdemlException.Code", _Code);
